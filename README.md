...
npm install
mkdir build
# Dev: watchify -t [ babelify --presets [ react es2015 ] ] -p tsify --debug src/index.tsx -o build/app.js
browserify -t [ babelify --presets [ react es2015 ] ]  -p tsify src/index.tsx -o build/app.js
go build
./leapchat
```
